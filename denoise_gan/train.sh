...
# Apply pre-emphasis AND apply biases to all conv layers (best SEGAN atm) original batch=100, epoch =86
CUDA_VISIBLE_DEVICES="0,1" python3 main.py --init_noise_std 0. --save_path segan_allbiased_preemph \
                                          --init_l1_weight 100. --batch_size 100 --g_nl prelu \
